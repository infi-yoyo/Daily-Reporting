...
where st.regional_manager_id = 26) as a
left join (
 select 
        device,
...
emails = {
    "Rohan": "rohan.sharma1@bluestone.com",
    "Shruti": "shruti.pantode@bluestone.com",
    "Naman Modi": "naman.modi@bluestone.com",
    "Arafat Ahmed": "arafat.ahmed@bluestone.com",
    "Ashwini": "ashwini.sutar1@bluestone.com"
...
cc_emails = ['mitul.malhotra@bluestone.com','mudita.gupta@bluestone.com',
 'Ayush.mishra@bluestone.com', 'Raveenkaur.pardal@bluestone.com', 'sachin.dave@bluestone.com', 'harshal@goyoyo.ai',
 'nikhil@goyoyo.ai',
 'pranet@goyoyo.ai',
 'rohan@goyoyo.ai',
 'adarsh@goyoyo.ai']
